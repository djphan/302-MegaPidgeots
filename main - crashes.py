...
import SceneManager
import sys
sys.path.insert(0, "C:\\Users\\Aedan\\Desktop\\Homework Folder\\CMPUT 302\\302-MegaPidgeots") #set to project folder
sys.path.insert(0, "C:\\Anaconda\\Scripts") #set to project folder
...
#window = mainmenu.main()
window = tabdialog.main()
#sys.exit(app.exec_())
